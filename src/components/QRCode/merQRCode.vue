  ...
  <div class="mer-qrcode">
    <el-form ref="form" :model="form" label-width="90px" label-position="left">
      <el-form-item label="商户名称：">
        <el-input v-model="form.name" placeholder="商户名称"></el-input>
      </el-form-item>
      ...
      <el-form-item label="经营类目：">
        <el-select v-model="form.catag" placeholder="经营类目">
          <el-option v-for="item in catag" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="业主姓名：">
        <el-input v-model="form.boss" placeholder="业主姓名"></el-input>
      </el-form-item>
      <el-form-item label="手机号码：">
        <el-input v-model="form.mobile" placeholder="手机号码" :maxlength="11"></el-input>
      </el-form-item>
    </el-form>
